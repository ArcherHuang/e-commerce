...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return Promise.all([
      ...
      queryInterface.renameColumn('Categories', 'productId', 'product_id'),
  ...
  down: (queryInterface, Sequelize) => {
    ...
    return Promise.all([
      ...
      queryInterface.renameColumn('Categories', 'product_id', 'productId'),
      ...
      queryInterface.renameColumn('Users', 'is_valide', 'isValid'),
    ]);
  }
};
